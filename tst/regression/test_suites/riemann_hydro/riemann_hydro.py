...
class TestCase(utils.test_case.TestCaseAbs):
    ...
    def Analyse(self, parameters):
        ...
        test_success = True
        exact_rho = interpolate.interp1d(
            x_ex, rho_ex, fill_value=(1.0, 0.125), bounds_error=False
        )
        exact_v = interpolate.interp1d(
            x_ex, v_ex, fill_value=(0.0, 0.0), bounds_error=False
        )
        exact_p = interpolate.interp1d(
            x_ex, p_ex, fill_value=(0.1, 0.1), bounds_error=False
        )
