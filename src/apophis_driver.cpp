...
ApophisDriver::ApophisDriver(ParameterInput *pin, ApplicationInput *app_in, Mesh *pm)
    : MultiStageDriver(pin, app_in, pm) {
  pin->CheckRequired("parthenon/time", "cfl");
}

TaskCollection ApophisDriver::MakeTaskCollection(BlockList_t &blocks, int stage) {
  TaskCollection tc;
